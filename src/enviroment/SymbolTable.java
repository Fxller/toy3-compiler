...
public class SymbolTable {
    ...
    public void addId(Scope.Group kind, String id, String type) {
        this.currentScope.getScope().get(kind).put(id, type);
    }

    public String lookup(Scope.Group kind, String id) {
    ...
    public boolean probe(Scope.Group kind, String id) {
